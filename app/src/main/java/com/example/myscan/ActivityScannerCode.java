...
import com.example.myscan.scanner.CameraManager;
import com.example.myscan.scanner.OnRxScannerListener;
import com.example.myscan.scanner.PlanarYUVLuminanceSource;
import com.example.myscan.scanner.decode.InactivityTimer;
import com.example.myscan.tool.RxAnimationTool;
import com.example.myscan.tool.RxQrBarTool;
 ...
 * @author tamsiree
 */
public class ActivityScannerCode extends FragmentActivity {
    ...
    private ImageView mIvMonitor;//添加摄像头的图片
    /**
     * 设置扫描信息回调
     */
    public static void setScannerListener(OnRxScannerListener scannerListener) {
    ...
    private void initView() {
        ...
        mIvMonitor = findViewById(R.id.scanner_iv_monitor);

        if(getIntent().getBooleanExtra("isMonitor",false)) {
            mIvMonitor.setVisibility(View.VISIBLE);
        }
    }
    ...
    private void initDialogResult(Result result) {
        ...
        builder.setMessage("扫描结果：" + realContent);
